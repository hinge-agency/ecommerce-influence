...
For each item in your RSS feed, SPP will look in this field for your show notes.

<table class="form-table"><tbody><tr>
	<th scope="row">Cache Timeout:</th>
	<td><?php text_input("spp_player_advanced[cache_timeout]", $cache_timeout) ?> minutes</td>
</tr></tbody></table>
This adjusts how often SPP checks your feed for new episodes.
...
The preferred source for artist and title information for the Smart Track Player.<br>
Setting the artist or title in a player's shortcode will override this.

<table class="form-table"><tbody><tr>
	<th scope="row">Download Method: </th>
	<td><?php select_input("spp_player_advanced[downloader]", $downloader,
			array("smart" => "Automatic (Recommended)", "fopen" => "Stream (fopen)",
				"local" => "Local File Cache")) ?></td>
</tr></tbody></table>
This adjusts how Smart Podcast Player requests files from your podcast host.
...
Add the CSS "!important" declaration to all of Smart Podcast Player's styles.
...
Prevent SPP from loading the Wordpress color picker Javascript in the admin settings pages.
